...
<template>
  <section class="author">
    <header class="bar">
      ...
      <div class="grp">
        <button class="btn" :class="{ on: showJson }" @click="showJson = !showJson">
          { } JSON
        </button>
      </div>
    </header>
    ...
    <div class="layout">
      ...
      <aside class="rail">
        <div class="zone">
          ...
          <ul>
            <li
              :class="{ on: view.kind === 'global' && view.id === 'job' }"
              @click="selectGlobal('job')"
            >
              <span>Basics</span>
            </li>
            <li
              :class="{ on: view.kind === 'global' && view.id === 'alloc' }"
              @click="selectGlobal('alloc')"
            >
              <span>Node allocation</span><span v-if="allocActive" class="dot" />
            </li>
            <li
              :class="{ on: view.kind === 'global' && view.id === 'run' }"
              @click="selectGlobal('run')"
            >
