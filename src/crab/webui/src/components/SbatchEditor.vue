...
<template>
  <div class="sbatch">
    <p class="hint">
      One <code>#SBATCH</code> directive per line, e.g. <code>--time=00:20:00</code> or
      <code>--exclusive</code>. <code>--nodes</code> / <code>--ntasks-per-node</code> are set by
      CRAB and ignored.
    </p>
    <textarea
      v-model="text"
