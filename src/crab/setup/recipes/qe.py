...
class QERecipe(BenchmarkRecipe):
    ...
    def download_and_build(
        ...
        if not self.run_command_streamed(["git", "clone", repo_url, target_dir], ".", "Cloning Q-E...", env, log_callback):
        ...
        return True, BuildResult(binary_path=bin_dir, metadata={"target_arch": target_arch}), "QE built successfully."
