...
class QERecipeV7(BenchmarkRecipe):
    ...
    @property
    def name(self) -> str: return "Quantum ESPRESSO v7"

    @property
    def suite(self) -> str: return "Quantum ESPRESSO"

    @property
    def benchmark_id(self) -> str: return "qe-v7"
    ...
    def download_and_build(
        ...
        if not self.run_command_streamed(["git", "clone", repo_url, target_dir], ".", "Cloning Q-E v7...", env, log_callback):
        ...
        return True, BuildResult(binary_path=bin_dir, metadata={"target_arch": target_arch}), "QE v7 built successfully."
