# CRAB roadmap, July 2026 edition (streams)

**Superseded (2026-09-24):** the current plan of record is the [milestone roadmap](roadmap.md).
This page keeps the stream-based version (written 2026-07-10, last amended 2026-09-22),
unchanged below, as the record of what was planned then. Its links are relative to `docs/dev/`, like the current roadmap.
